...
<footer class="card-footer">
  <b-button icon-left="play" @click="play" style="margin:1rem" type="is-success">
  </b-button>
  <b-button icon-left="stop" @click="stop" style="margin-top:1rem" type="is-danger">
  </b-button>
  <b-button icon-left="skip-next" @click="skip" style="margin:1rem" type="is-warning">
  </b-button>
</footer>
</div>
</template>
